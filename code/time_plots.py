...
from multiple_bar_plots import ax_circle_from_data
...
############################################################
    print(pd_cost[0])
    ax_circle_from_data(a_seller_pos, a_buyer_pos, a_m_quantity_bought[0],
            a_color=a_color, gamma=gamma, a_cost=pd_cost[0], ax=ax_circle)
